...
import { TotalYieldDataKey, TotalYieldDataForToken, TotalYieldDataForTokenLibrary, StrategyId, CustomUintSizeChecks } from "../../../../src/vault/types/TotalYieldDataForToken.sol";
...
contract TotalYieldDataForTokenTest is PRBTest, StdUtils {
  ...
  mapping(TotalYieldDataKey => TotalYieldDataForToken) internal _totalYieldData;
  ...
  function testFuzz_update(uint152 accumulator, uint104 totalBalance, uint8 lossEvents) public {
    ...
    (uint256 yieldAccumulator, uint256 lastRecordedTotalBalance, uint256 totalLossEvents) = _totalYieldData.read(STRATEGY_ID, TOKEN);
