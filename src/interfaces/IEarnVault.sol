 ...
 *         access control and makes sure that users can only access their own funds. The vault will also keep track of
 *         fees generated by Balmy
 */
interface IEarnVault is INFTPermissions {
  /// @notice The funds available for a specific strategy
  struct FundsInStrategy {
    address[] tokens;
    uint256[] balances;
  }

  /// @notice How much was withdrawn from a specific strategy
  struct WithdrawnFromStrategy {
    address[] tokens;
    uint256[] withdrawn;
  ...
  /**
   * @notice Returns the address of the fee manager
   * @return The address of the fee manager
   */
  // slither-disable-next-line naming-convention
  function FEE_MANAGER() external view returns (IEarnFeeManager);
  ...
  /**
   * @notice Returns the amount of fees generated for the given strategies
   * @param strategies The strategies to withdraw fees for
   * @return generated The generated fees funds
   */
  ...
  /**
   * @notice Withdraws fees generated for the given strategies
   * @dev Can only be called by someone with the `WITHDRAW_FEES_ROLE` role
   * @param strategies The strategies to withdraw fees for
   * @param recipient The account that will receive the withdrawn funds
   * @return withdrawn The withdrawn funds
   */
